...
\begin{figure}[h]
  \centering
  \subfloat[{Replication of~\cite[Figure~C1, p.~41]{reardon2018levels}}]{{\includegraphics[width=.5\linewidth]{figures/figC1.png}}}%
  \hfill%
  \subfloat[{Original (reprinted from~\cite[Figure~C1]{reardon2018levels_preprint})}]{{\includegraphics[width=.5\linewidth]{figures_original/figC1.png}}}%
...
\begin{figure}[h]
  \centering
  \subfloat[{Replication of~\cite[Figure~C2, p.~42]{reardon2018levels}}]{{\includegraphics[width=.5\linewidth]{figures/figC2.png}}}%
  \hfill%
  \subfloat[{Original (reprinted from~\cite[Figure~C2]{reardon2018levels_preprint})}]{{\includegraphics[width=.5\linewidth]{figures_original/figC2.png}}}%
...
\begin{figure}[p]
  \centering
  \subfloat[{Replication of~\cite[Figure~C4, p.~44]{reardon2018levels}}]{{\includegraphics[width=.5\linewidth]{figures/figC4.png}}}%
  \hfill%
  \subfloat[{Original (reprinted from~\cite[Figure~C4]{reardon2018levels_preprint})}]{{\includegraphics[width=.5\linewidth]{figures_original/figC4.png}}}%
...
\begin{figure}[p]
  \centering
  \subfloat[{Replication of~\cite[Figure~C5, p.~45]{reardon2018levels}}]{{\includegraphics[width=.5\linewidth]{figures/figC5.png}}}%
  \hfill%
  \subfloat[{Original (reprinted from~\cite[Figure~C5]{reardon2018levels_preprint})}]{{\includegraphics[width=.5\linewidth]{figures_original/figC5.png}}}%
...
\begin{figure}[p]
  \centering
  \subfloat[{Replication of~\cite[Figure~3 (left), p.~17]{reardon2018levels}}]{{\includegraphics[width=.65\linewidth]{figures/fig3A.png}}}%
  \subfloat[{Original (reprinted from~\cite[Figure~3 (left)]{reardon2018levels_preprint})}]{{\includegraphics[width=.3\linewidth]{figures_original/fig3A.png}}}%
...
\begin{figure}[p]
  \centering
  \subfloat[{Replication of~\cite[Figure~2, p.~15]{reardon2018levels}}]{{\includegraphics[width=.75\linewidth]{figures/fig2.png}}} \\
  \subfloat[{Original (reprinted from~\cite[Figure~2]{reardon2018levels_preprint})}]{{\includegraphics[width=.9\linewidth]{figures_original/fig2.png}}}%
...
\begin{figure}[p]
  \centering
  \subfloat[{Reproduction of~\cite[Figure A2, p.~30]{reardon2018levels}: racial composition}]{{\includegraphics[width=.75\linewidth]{figures/figA2.png}}} \\
  \subfloat[{Reproduction of~\cite[Figure A3, p.~31]{reardon2018levels}: socioeconomic composition}]{{\includegraphics[width=.75\linewidth]{figures/figA3.png}}}
  \caption{Replication and original composition of colleges using SES-based affirmative action
...
\begin{figure}[p]
  \centering
  \subfloat[{Reproduction of~\cite[Figure A4, p.~32]{reardon2018levels}: racial composition}]{{\includegraphics[width=.75\linewidth]{figures/figA4.png}}} \\
  \subfloat[{Reproduction of~\cite[Figure A5, p.~33]{reardon2018levels}: socioeconomic composition}]{{\includegraphics[width=.75\linewidth]{figures/figA5.png}}} 
  \caption{Replication and original composition of colleges using SES-based and racial affirmative actions, by affirmative action weights.}
  \label{fig:A45}
\end{figure}

\clearpage % force all figures to be printed before discussing results
