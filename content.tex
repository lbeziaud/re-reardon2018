...
\begin{figure}[p]
  ...
  \subfloat[{Replication}]{%
    \raisebox{6mm}[0pt][0pt]{\includegraphics[width=.4\textwidth]{figures/figC1.png}}
  }%
...
\begin{figure}[p]
  ...
  \hfill%
  \subfloat[{Replication}]{{\includegraphics[width=.51\textwidth]{figures/figD1.png}}}%
...
% TODO: what happens if you use the former? Do the results change?
